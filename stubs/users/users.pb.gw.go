...
func request_Users_Ping_0(ctx context.Context, marshaler runtime.Marshaler, client UsersClient, req *http.Request, pathParams map[string]string) (Users_PingClient, runtime.ServerMetadata, error) {
...
func RegisterUsersHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UsersServer) error {
	...
	mux.Handle("POST", pattern_Users_Ping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterUsersHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UsersClient) error {
	...
	mux.Handle("POST", pattern_Users_Ping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/users.Users/Ping", runtime.WithHTTPPathPattern("/"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Users_Ping_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		...
		forward_Users_Ping_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Users_Ping_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{""}, ""))
)

var (
	forward_Users_Ping_0 = runtime.ForwardResponseStream
)
